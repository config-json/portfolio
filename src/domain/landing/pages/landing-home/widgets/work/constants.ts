...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    description: "A social platform to send and receive money seamlessly on the blockchain",
  ...
  },
  {
    ...
    tags: ["Brand Design", "UI/UX", "TailwindCSS", "React"],
    text: [
      "Built a simple app that displays the status of major financial markets"
    ]
  }
]